...
public class Custom : MonoBehaviour
{
    ...
    //任何具有[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]属性的static public方法, 都会尝试导出为自定义方法, 而不产生对应的包装方法,仅仅自动注册到对应的lua接口里,不产生对应的包装方法再包装这个函数, 这使得你可以实现自己的任何lua函数
    ...
    //如果你需要个静态方法, 需要多加一个[StaticExport]
    [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[StaticExport]
